export default {
  common: {
    ...
    userMenu: 'User menu',
    serviceRegionNotice: '⚠ Service Region Notice: This website provides services exclusively to Chinese users residing overseas. Users in mainland China, Hong Kong, Macao, or Taiwan must not register for or use this service. Accounts found in violation will be banned immediately.',
