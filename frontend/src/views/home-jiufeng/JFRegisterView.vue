        ...
        <div class="jf-register-card" aria-labelledby="register-title">
          ...
          <form v-else class="jf-form" @submit.prevent="handleRegister">
            ...
            <div class="jf-field">
              ...
              <div class="jf-input-wrap jf-password-wrap" :class="{ 'is-error': errors.confirmPassword }">
                <Icon name="lock" size="md" />
                <input
                ...
                <button
                  ...
                  class="jf-eye"
                  :disabled="registrationActionDisabled"
                  :aria-label="showConfirmPassword ? registerCopy.hidePassword : registerCopy.showPassword"
            ...
            <div v-else-if="affiliateEnabled" class="jf-field" data-testid="affiliate-invitation-field">
              <label for="register-affiliate-code">
                {{ t('auth.invitationCodeLabel') }}
            ...
            <div v-if="captchaEnabled" class="jf-turnstile">
              <TurnstileWidget
                ref="turnstileRef"
            ...
            <div class="jf-agreement-row">
              ...
              <label for="register-agreement">
                ...
                <template v-for="(doc, index) in visibleAgreementDocuments" :key="doc.id || doc.title">
                  <button
                    type="button"
                    @click.prevent.stop="openAgreementDocument(doc)"
                  >
                    {{ doc.title }}
                  </button>
            ...
            <LoginAgreementPrompt
              v-if="visibleAgreementDocuments.length > 0"
              ref="agreementPromptRef"
              :accepted="agreementRowChecked"
              :documents="visibleAgreementDocuments"
              :mode="loginAgreementMode"
              :show-inline-control="false"
              :updated-at="loginAgreementUpdatedAt"
              :visible="loginAgreementEnabled && showAgreementModal"
...
import LoginAgreementPrompt from '@/views/home-jiufeng/JFLoginAgreementPrompt.vue'
...
const promoCodeEnabled = ref(appStore.cachedPublicSettings?.promo_code_enabled === true)
...
const agreementPromptRef = ref<{
  openDocument: (document: LoginAgreementDocument) => Promise<void>
} | null>(null)
...
function openAgreementDocument(document: LoginAgreementDocument): void {
  void agreementPromptRef.value?.openDocument(document)
}
...
.jf-agreement-row button:hover,
.jf-agreement-row button:focus-visible {
  color: #087f70;
}
