<template>
  <AppLayout>
    <div class="jf-admin-dashboard jf-chart-palette space-y-6">
      <!-- Loading State -->
        ...
        <div class="card p-4">
          ...
          <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            <button
              ...
              @click="router.push(jiufengNavigationTarget('/admin/groups', authStore))"
            >
...
import { jiufengNavigationTarget } from '../navigation'
