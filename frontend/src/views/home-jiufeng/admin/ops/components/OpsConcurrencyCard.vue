...
.custom-scrollbar {
  ...
  scrollbar-color: var(--jf-scrollbar-thumb) var(--jf-scrollbar-track);
}
...
.custom-scrollbar::-webkit-scrollbar-track {
  background: var(--jf-scrollbar-track);
}

.custom-scrollbar::-webkit-scrollbar-thumb {
  background-color: var(--jf-scrollbar-thumb);
  border-radius: 3px;
}

.custom-scrollbar::-webkit-scrollbar-thumb:hover {
  background-color: var(--jf-scrollbar-thumb-hover);
}
</style>
