      ...
      <div>
        <h1 class="flex items-center gap-2 text-xl font-black text-gray-900 dark:text-white">
          <svg class="h-6 w-6 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 16v5" />
            <path stroke-linecap="round" d="M16 14.639V21" />
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 10.656V21" />
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m22 3-8.646 8.646a.5.5 0 0 1-.708 0L9.354 8.354a.5.5 0 0 0-.707 0L2 15" />
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 18.463V21" />
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 14.656V21" />
          </svg>
          {{ t('admin.ops.title') }}
        </h1>
