<template>
  <AppLayout>
    <TablePageLayout>
      <template #filters>
        <div class="jf-account-toolbar flex flex-wrap-reverse items-start justify-between gap-3">
          <AccountTableFilters
            class="jf-account-table-filters"
          ...
          />
          <AccountTableActions
            class="jf-account-table-actions"
            :loading="loading"
