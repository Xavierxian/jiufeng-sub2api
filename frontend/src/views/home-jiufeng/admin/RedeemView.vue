<template>
  <AppLayout>
    <TablePageLayout class="jf-redeem-page">
      <template #filters>
        <div class="jf-redeem-toolbar flex flex-wrap items-center gap-3">
          <!-- Left: Search + Filters -->
          <div class="jf-redeem-search flex-1 sm:max-w-64">
            <input
              v-model="searchQuery"
              type="text"
          ...
          <div class="jf-redeem-actions flex flex-1 flex-wrap items-center justify-end gap-2">
            <button
              @click="loadCodes"
              :disabled="loading"
            ...
            >
              ...
              <span class="sm:hidden">{{ t('common.refresh') }}</span>
            </button>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-code="{ value }">
            <div class="jf-redeem-code flex min-w-0 items-center gap-2">
              <code class="min-w-0 break-all font-mono text-sm text-gray-900 dark:text-gray-100">{{ value }}</code>
              <button
...
<style scoped>
.jf-redeem-page :deep([data-field] > span) {
  flex-shrink: 0;
}

.jf-redeem-page :deep([data-field] > div) {
...
@media (max-width: 640px) {
  ...
  .jf-redeem-actions .btn {
    min-width: 0;
    gap: 6px;
    white-space: nowrap;
  }

  .jf-redeem-actions .btn :deep(svg) {
    flex-shrink: 0;
    margin-right: 0;
  }
}
