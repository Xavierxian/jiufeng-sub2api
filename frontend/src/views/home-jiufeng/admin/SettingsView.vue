                ...
                >
                  ...
                  <div class="md:col-span-2">
                    ...
                    <div class="mt-3 flex flex-wrap gap-x-4 gap-y-2 text-sm">
                      <a href="https://console.cloud.tencent.com/captcha" target="_blank" rel="noopener noreferrer" class="text-primary-600 hover:text-primary-500">
                        {{ t("admin.settings.tencentCaptcha.openCaptchaConsole") }}
                      </a>
                      <a href="https://console.cloud.tencent.com/cam/capi" target="_blank" rel="noopener noreferrer" class="text-primary-600 hover:text-primary-500">
                        {{ t("admin.settings.tencentCaptcha.createCloudKeys") }}
                      </a>
                      <a href="https://cloud.tencent.com/document/product/1110/36841" target="_blank" rel="noopener noreferrer" class="text-primary-600 hover:text-primary-500">
