  ...
  <AppLayout>
    <TablePageLayout>
      <template #filters>
        ...
        <div class="jf-subscription-toolbar flex flex-wrap items-start justify-between gap-4">
          <!-- Left: Fuzzy user search + filters (wrap to multiple lines) -->
          <div class="jf-subscription-filters flex flex-1 flex-wrap items-center gap-3">
            <!-- User Search -->
            <div
              class="jf-subscription-search relative w-full sm:w-64"
          ...
          <!-- Right: Actions -->
          <div class="jf-subscription-actions ml-auto flex flex-wrap items-center justify-end gap-3">
            <button
        ...
        <div>
          ...
          <div class="relative" data-assign-user-search>
            ...
            >
              ...
              <button
                ...
                class="w-full px-4 py-2 text-left text-sm hover:bg-gray-100 disabled:opacity-50 dark:hover:bg-gray-700"
              >
                <span class="font-medium text-gray-900 dark:text-white">{{ user.email }}</span>
                <span class="ml-2 text-gray-500 dark:text-gray-400">#{{ user.id }}</span>
              </button>
          ...
          <div v-if="batchAssignEnabled && assignUsers.length > 0" class="mt-2 space-y-2" data-test="assign-users">
            ...
            <ul class="max-h-40 space-y-1 overflow-y-auto">
              <li v-for="user in assignUsers" :key="user.id" class="flex items-center justify-between gap-2 rounded-lg bg-gray-50 px-3 py-1 text-sm dark:bg-gray-700">
...
@media (max-width: 640px) {
  .jf-subscription-toolbar {
    flex-direction: column;
    gap: 10px;
  }

  .jf-subscription-filters {
    display: grid;
    width: 100%;
  ...
  .jf-subscription-actions {
    width: 100%;
    gap: 8px;
  }

  .jf-subscription-actions .btn {
    flex-shrink: 0;
    white-space: nowrap;
  }
}
