<template>
  <AppLayout>
    <div class="jf-chart-palette space-y-6">
      <JFUsageStatsCards :stats="usageStats" :trend-data="trendData" />
      <!-- Charts Section -->
      <div class="space-y-4">
        <div class="card p-4">
...
import AppLayout from '@/views/home-jiufeng/JFAppLayout.vue'; import Pagination from '@/components/common/Pagination.vue'; import Select from '@/components/common/Select.vue'; import DateRangePicker from '@/components/common/DateRangePicker.vue'
import JFUsageStatsCards from '@/views/home-jiufeng/components/JFUsageStatsCards.vue'; import UsageFilters from '@/components/admin/usage/UsageFilters.vue'
import UsageTable from '@/components/admin/usage/UsageTable.vue'; import UsageExportProgress from '@/components/admin/usage/UsageExportProgress.vue'
import UserTokenRanking from '@/components/admin/usage/UserTokenRanking.vue'
import UsageCleanupDialog from '@/components/admin/usage/UsageCleanupDialog.vue'
import UserBalanceHistoryModal from '@/components/admin/user/UserBalanceHistoryModal.vue'
import OpsErrorLogTable from '@/views/home-jiufeng/admin/ops/components/OpsErrorLogTable.vue'
import OpsErrorDetailModal from '@/views/home-jiufeng/admin/ops/components/OpsErrorDetailModal.vue'
...
// Add each newly introduced column without resetting the user's saved visibility choices.
