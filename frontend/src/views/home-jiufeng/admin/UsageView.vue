  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      <div class="card">
        ...
        <!-- 鎳掓寕杞斤細棣栨鍒囧埌璇?tab 鎵嶈姹傛帓琛屾暟鎹紝涔嬪悗闅忕瓫閫夎嚜鍔ㄥ埛鏂?-->
...
// ---- 閿欒璇锋眰 tab 鍒楄缃?涓庣敤閲忔槑缁嗗悓鏈哄埗,鐙珛瀛樺偍) ----
...
// 娉ㄦ剰锛?YYYY-MM-DDT00:00:00' 鏃犳椂鍖哄悗缂€锛屾寜鏈湴鏃跺尯瑙ｆ瀽鍚庡啀杞?UTC鈥斺€斾笌椤甸潰鍏跺畠鏃ユ湡澶勭悊璇箟涓€鑷达紝鍒绘剰濡傛锛屽嬁鏀规垚 'T00:00:00Z'
