<template>
  <div class="jf-setup-page">
    <JFPublicHeader :show-login="false" />
    <main class="jf-setup-main">
      <div class="w-full max-w-2xl">
      <!-- Logo & Title -->
      <div class="mb-8 text-center">
        <div class="jf-setup-mark">
...
.jf-setup-page :deep(.input),
.jf-setup-page :deep(.btn),
.jf-setup-page :deep(.rounded-xl),
.jf-setup-page :deep(.rounded-2xl) {
  border-radius: 6px !important;
}

:global(.dark .jf-setup-page) {
  background: #0b0b0d;
  color: #f3f4f6;
}

:global(.dark .jf-setup-mark) {
  border-color: rgba(32, 199, 179, 0.24);
  background: rgba(32, 199, 179, 0.14);
  color: #5eead4;
}

:global(.dark .jf-setup-panel) {
  border-color: #2a2a30;
  background: #121214;
