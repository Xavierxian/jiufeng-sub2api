      ...
      <section class="jf-verify-panel">
        <div class="jf-verify-card" aria-labelledby="verify-title">
          ...
          <form v-else class="jf-form" @submit.prevent="handleVerify">
            ...
            <div v-if="actionCaptchaEnabled || (turnstileEnabled && showResendTurnstile)" class="jf-turnstile">
              <TurnstileWidget
                ref="turnstileRef"
            ...
            <div v-if="pendingOAuthCreateCaptchaEnabled" class="jf-turnstile">
              <TurnstileWidget
...
function clearStoredCaptchaProof(): void {
  ...
  try {
    ...
    // Invalid registration state is handled by the existing mount parser.
  }
}
