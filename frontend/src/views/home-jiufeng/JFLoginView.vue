    ...
    <section class="sui-login-shell" :class="{ 'sui-login-shell--en': !isZhLocale }">
      ...
      <section class="sui-card" aria-labelledby="login-title">
        ...
        <form class="sui-form" @submit.prevent="handleLogin">
          ...
          <div v-if="captchaEnabled" class="sui-turnstile">
            <TurnstileWidget
              ref="turnstileRef"
          ...
          <div v-if="showPasskeyLogin || showOAuthLogin" class="sui-oauth">
...
<p v-if="!backendModeEnabled && publicSettingsLoaded && registrationEnabled" class="sui-register">
            {{ loginCopy.noAccount }}
