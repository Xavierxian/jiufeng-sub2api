        ...
        <fieldset v-if="!showEditModal" data-tour="key-form-provider">
          ...
          <div class="grid grid-cols-2 gap-2 sm:grid-cols-4">
            ...
            >
              ...
              <span v-if="createProvider === provider.value" class="absolute right-1.5 top-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-primary-500 text-white" aria-hidden="true">
