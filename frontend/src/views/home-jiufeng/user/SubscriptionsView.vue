<template>
  <AppLayout v-if="!subscriptionsDisabled">
    <div class="space-y-6">
      <!-- Loading State -->
...
<script lang="ts">
import { subscriptionAccessGuard } from './subscriptionAccess'
export default { beforeRouteEnter: subscriptionAccessGuard }
</script>
...
const subscriptionsDisabled = computed(() => appStore.publicSettingsLoaded &&
...
onMounted(async () => {
  ...
  if (subscriptionsDisabled.value) {
