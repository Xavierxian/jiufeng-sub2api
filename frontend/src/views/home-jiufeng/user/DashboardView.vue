<template>
  <AppLayout>
    <div class="jf-user-dashboard jf-chart-palette space-y-6">
...
import AppLayout from '@/views/home-jiufeng/JFAppLayout.vue'; import LoadingSpinner from '@/components/common/LoadingSpinner.vue'
