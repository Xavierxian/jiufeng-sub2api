#!/bin/bash
#
# jiufeng-api Installation Script
# jiufeng-api 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Xavierxian/jiufeng-sub2api/main/deploy/install.sh | sudo bash
#
...
# Configuration
GITHUB_REPO="Xavierxian/jiufeng-sub2api"
...
declare -A MSG_ZH=(
    ...
    # Installation
    ["install_title"]="jiufeng-api 安装脚本"
    ...
    # Completion
    ["install_complete"]="jiufeng-api 安装完成！"
    ["install_dir"]="安装目录"
    ["next_steps"]="后续步骤"
    ["step1_check_services"]="确保 PostgreSQL 和 Redis 正在运行："
    ["step2_start_service"]="启动 jiufeng-api 服务："
    ...
    ["not_installed"]="jiufeng-api 尚未安装，请先执行全新安装"
    ["fresh_install_hint"]="用法"

    # Uninstall
    ["uninstall_confirm"]="这将从系统中移除 jiufeng-api。"
    ...
    ["uninstall_complete"]="jiufeng-api 已卸载"

    # Help
    ["usage"]="用法"
    ["cmd_none"]="(无参数)"
    ["cmd_install"]="安装 jiufeng-api"
    ["cmd_upgrade"]="升级到最新版本"
    ["cmd_uninstall"]="卸载 jiufeng-api"
    ...
    ["server_config_desc"]="配置 jiufeng-api 服务监听地址"
...
declare -A MSG_EN=(
    ...
    # Installation
    ["install_title"]="jiufeng-api Installation Script"
    ...
    # Completion
    ["install_complete"]="jiufeng-api installation completed!"
    ["install_dir"]="Installation directory"
    ["next_steps"]="NEXT STEPS"
    ["step1_check_services"]="Make sure PostgreSQL and Redis are running:"
    ["step2_start_service"]="Start jiufeng-api service:"
    ...
    # Upgrade
    ["upgrading"]="Upgrading jiufeng-api..."
    ...
    ["not_installed"]="jiufeng-api is not installed. Please run a fresh install first"
    ["fresh_install_hint"]="Usage"

    # Uninstall
    ["uninstall_confirm"]="This will remove jiufeng-api from your system."
    ...
    ["uninstall_complete"]="jiufeng-api has been uninstalled"

    # Help
    ["usage"]="Usage"
    ["cmd_none"]="(none)"
    ["cmd_install"]="Install jiufeng-api"
    ["cmd_upgrade"]="Upgrade to the latest version"
    ["cmd_uninstall"]="Remove jiufeng-api"
    ...
    ["server_config_desc"]="Configure jiufeng-api server listen address"
...
[Unit]
Description=jiufeng-api - AI API Gateway Platform
Documentation=https://github.com/Xavierxian/jiufeng-sub2api
...
# Upgrade function
upgrade() {
    # Check if jiufeng-api is installed
    if [ ! -f "$INSTALL_DIR/sub2api" ]; then
...
# Requires: jiufeng-api must already be installed
install_version() {
